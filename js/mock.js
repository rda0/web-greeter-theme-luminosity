...
if (typeof lightdm == 'undefined') {
  ...
  lightdm.sessions = [{ key: "gnome", name: "gnome", comment: "no comment" }, { key: "cinnamon", name: "cinnamon", comment: "no comment" }, { key: "openbox", name: "openbox", comment: "no comment" }, { key: "enlightenment", name: "enlightenment", comment: "no comment" }, { key: "lxqd", name: "lxqt", comment: "no comment" }];
